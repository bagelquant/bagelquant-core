...
OPERATION_DESCRIPTIONS = {
    ...
    "delta": "Return the per-asset value difference from the observation at the configured interval.",
    "demean": "Subtract the same-date cross-sectional mean from every present value.",
    "denoise": "Suppress small cross-sectional deviations while retaining the dominant signal.",
    ...
    "ffill": "Forward-fill missing values within each asset using an explicit finite limit.",
    ...
    "lag": "Shift each asset's values backward by the configured number of observations.",
    ...
    "mask": "Keep values from the first input only where the aligned mask input is truthy.",
    ...
    "orthogonalize": "Remove the component of the first aligned panel explained by the remaining panels within each date cross-section.",
    ...
    "project": "Project the first aligned panel onto the second and return the fitted component.",
    "rank": "Return same-date cross-sectional ranks while preserving missing membership.",
    "rankpct": "Return same-date cross-sectional percentile ranks.",
    ...
    "vol_scale": "Scale the first input by trailing volatility estimated from the aligned reference input.",
    ...
    "zscore": "Standardize values within each same-date cross-section.",
}
